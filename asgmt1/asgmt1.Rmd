...
We can find an outlier in the sunflower group by z-score, since the 6th z-score in the group is lower than -2, the coincident weight is too small to count, thus we remove it.
...
Sunflower feed is the best feed supplement.
<!--
...
ANOVA test and kruskal test have the same result.