...
So, estimated longevity of *high* group is `r exp(coef["(Intercept)"])`, 
estimated longevity of *low* group is `r exp(coef["(Intercept)"] + coef["activitylow"])`, 
estimated longevity of *isolated* group is `r exp(coef["(Intercept)"] + coef["activityisolated"])`.
