...
totAge <- xtabs(~Age, data=life_data)
barplot(xtabs(Survived~Age, data=life_data)/totAge)
...
```
We find:
1) The barplot shows the survival rate percentage per age group, passengers who younger than 16 and older than 52 have greater survival rate.
