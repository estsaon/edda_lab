...
```{r}
coef2 <- summary(glm(
    miltcoup~oligarchy+pollib+parties, family=poisson, data=coup_data)
)$coefficients; coef2
```
...
`r coef["oligarchy", "Estimate"]` * 
oligarchy `r coef["pollib", "Estimate"]` * 
pollib + `r coef["parties", "Estimate"]` * parties
...
We find that if a country has the averages of oligarchy and parties, the number of coups will less than 2, 
which decreases with the increasing of the political liberalization.