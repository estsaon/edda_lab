...
Since the data is consisted of two factors---column and word, the interest is different word count in different columns. Moreover, more than 80% of the expected counts are above 5. Hence, a contingency table test is appropriate to test independence.
...
the p < 0.05, Austen herself was inconsistent in her different novels.
...
From the table of residuals we see that sand2 has relatively more an's and with's, and has relatively less that's. Hence, the admirer isn't successful in imitating Austen's style.
