...
1. cow factor does not effect lactation; 

2. the first treatment or the second treatment does not effect lactation;

3. the type of feedingstuffs/treatment does not effect lactation. 
...
whether a cow goes through its first treatment or second (p = `r result["per", ]$Pr` < 0.05) do effect lactation. 
But the factor of interest, namely type of treatment (p = `r result["treatment", ]$Pr` > 0.05) does not effect lactation significantly. 
...
does not significantly effect the lactation, which is the same with the previous fixed effect model. 
...
Whether a cow goes through its first treatment or second (p = `r result["cow_lmer", "Pr(>Chisq)"]` < 0.05) still effect lactation significantly. 
...
This is because because F-test is the generalization of t-test.  
