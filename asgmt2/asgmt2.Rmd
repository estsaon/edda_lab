...
z
```
According to the above results, the p value is `r result$p.value`, which is greater than 0.05. 
...
2) chapters 1, 2 and 3 of Emma have relatively fewer 'a', 'an', 'that' and more 'without';  
3) chapters 1 and 3 of Sense and Sensibility have have relatively fewer 'this' and 'with'.
...
the p-value is `r result$p.value` < 0.05 after adding the admirer's word frequencies, 
