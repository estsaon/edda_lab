...
that is to say both of the factors and their interaction have great effect on the decay.
  2. The decay time decreases with the environment gets wetter and the temperature gets warmer. Moreover, the interaction of two factors stresses the explication.
