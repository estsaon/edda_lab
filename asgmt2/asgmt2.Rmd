...
To estimate the search time of the combination of skill level 3 and interface 3, we apply additive model and summary again.

```{r}
search_additive_lm = lm(time~factor_interface * factor_skill)
coef <- summary(search_additive_lm)$coefficients[, "Estimate"]
```

We get the estimation time is `r coef["(Intercept)"] + coef["factor_interface3:factor_skill3"]`.
